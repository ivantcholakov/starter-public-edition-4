...
class Disputes extends Base_Controller {
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('open_claims', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('open_disputes', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('rejected_disputes', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('satisfied_disputes', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
