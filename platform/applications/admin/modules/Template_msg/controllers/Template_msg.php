...
class Template_msg extends Base_Controller {
    ...
    function __construct()
    {
        ...
        define('THIS_URL', base_url('admin/template_msg'));
		define('THIS_URL_2', base_url('admin/template_msg/sms'));
    ...
    function index()
    {
		...
		// set content data
         $data['page_header'] = 'Messages Templates';
        $content_data = array(
            'this_url'              => site_url('admin/template_msg'),
    ...
    function sms()
    {
        ...
        // load views
		$data['content'] = $this->load->view('sms', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
	...
	function edit_sms($id = NULL)
    {
        ...
        // load views
        $data['content'] = $this->load->view('sms_form', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
