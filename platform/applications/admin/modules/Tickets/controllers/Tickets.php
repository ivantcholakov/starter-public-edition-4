...
class Tickets extends Base_Controller {
    ...
    function untreated()
    {
        ...
        // load views
        $data['content'] = $this->load->view('untreated', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
    ...
    function processed()
    {
        ...
        // load views
        $data['content'] = $this->load->view('processed', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
    ...
    function closed()
    {
        ...
        // load views
        $data['content'] = $this->load->view('closed', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //      $data = $this->includes;
       ...
       // load views
        $data['page_header'] = 'Administration';
       $data['content'] = $this->load->view('add', NULL, TRUE);
       // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    ...
    function add_admin_comment($id)
    {
        ...
        $vals_1 = array($site_name, $link, $id_tickets);
