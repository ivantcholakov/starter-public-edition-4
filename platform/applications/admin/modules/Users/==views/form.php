    ...
    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
      <div class="card-header bordered">
       ...
       <ul class="nav nav-tabs pull-right" role="tablist">
          <li class="nav-item"> <a class="nav-link active" href="#overview" role="tab" data-toggle="tab"><?php echo 'Overview account';//lang('admin input overview'); ?></a> </li>
          <li class="nav-item"> <a class="nav-link" href="#wallet" role="tab" data-toggle="tab"><?php echo 'Wallet'//lang('admin input wallet'); ?></a></li>
          <li class="nav-item"> <a class="nav-link" href="#add" role="tab" data-toggle="tab"><?php echo 'Add Transctions';//lang('admin input add_transaction'); ?></a></li>
          <li class="nav-item"> <a class="nav-link" href="#all" role="tab" data-toggle="tab"><?php echo 'All Transctions';//lang('admin input all_transactions'); ?></a></li>
          <li class="nav-item"> <a class="nav-link" href="#logs" role="tab" data-toggle="tab"><?php echo 'Operations History';//lang('admin input login_history'); ?></a></li>
          <li class="nav-item"> <a class="nav-link" href="#doc" role="tab" data-toggle="tab"><?php echo 'Document';//lang('admin input document'); ?></a></li>
       </ul>
     </div>
     <div class="card-block">
        <div class="tab-content">
            ...
            <?php echo form_open('', array('role'=>'form')); ?>
              ...
              <div class="row">
                  ...
                  <div class="form-group col-sm-3<?php echo form_error('status') ? ' has-error' : ''; ?>">
                      ...
                      <div>
                          <label style="font-weight:500">
                              ...
                              <span><?php echo 'Active';//lang('admin input active'); ?></span>
                          </label>
                      </div>
                      <?php if ( ! $user['id'] OR $user['id'] > 1) : ?>
                          <div>
                              <label style="font-weight:500">
                                ...
                                <span><?php echo 'Inactive';//lang('admin input inactive'); ?></span>
                              </label>
                          </div>
                      <?php endif; ?>
                  </div>
                  ...
                  <div class="form-group col-sm-3<?php echo form_error('is_admin') ? ' has-error' : ''; ?>">
                      <?php echo 'Is Admin'//form_label(lang('users input is_admin'), '', array('class'=>'control-label')); ?>
                      <span class="required">*</span>
                      <?php if ( ! $user['id'] OR $user['id'] > 1) : ?>
                          <div>
                              <label style="font-weight:500">
                                ...
                                <span><?php echo 'No'; //lang('core text no'); ?></span>
                              </label>
                          </div>
                      <?php endif; ?>
                      <div>
                          <label style="font-weight:500">
                            ...
                            <span><?php echo 'Yes'//lang('core text yes'); ?></span>
                          </label>
                      </div>
                  </div>
                  ...
                  <div class="form-group col-sm-3<?php echo form_error('verifi_status') ? ' has-error' : ''; ?>">
                      <?php echo 'Verification Status' ; //form_label(lang('admin input verifi_status'), '', array('class'=>'control-label')); ?>
                      <span class="required">*</span>
                      <div>
                          <label style="font-weight:500">
                              ...
                              <span><?php echo 'verified';//lang('admin input verifi_ok'); ?></span>
                          </label>
                      </div>
                      <div>
                          <label style="font-weight:500">
                              ...
                              <span><?php echo 'Business';//lang('admin input business'); ?></span>
                          </label>
                      </div>
                       <div>
                          <label style="font-weight:500">
                              ...
                              <span><?php echo 'Waiting Verification';//lang('admin input waiting'); ?></span>
                          </label>
                      </div>
                          ...
                          <div>
                              <label style="font-weight:500">
                                  ...
                                  <span><?php echo 'Anonymous';//lang('admin input anonymous'); ?></span>
                              </label>
                          </div>
                  ...
                  <?php // fraud status ?>
                  <div class="form-group col-sm-3<?php echo form_error('verifi_status') ? ' has-error' : ''; ?>">
                      <?php echo 'Fraud status';//form_label(lang('admin input fraud_status'), '', array('class'=>'control-label')); ?>
                      <span class="required">*</span>
                      <div>
                          <label style="font-weight:500">
                            ...
                            <span><?php echo 'No limits ';//lang('admin input fraud_none'); ?></span>
                          </label>
                      </div>
                      <div>
                          <label style="font-weight:500">
                            ...
                            <span><?php echo 'No withdrawal ';//lang('admin input no_withdrawal'); ?></span>
                          </label>
                      </div>
                          ...
                          <div>
                              <label style="font-weight:500">
                                ...
                                <span><?php echo 'Banned all operations ';//lang('admin input fraud_banned'); ?></span>
                              </label>
                          </div>
              ...
              <div class="pull-right">
                <div class="col-md-12">
                  <a class="btn btn-secondary btn-sm" href="<?php echo $cancel_url; ?>"><?php echo 'Cancel';//lang('core button cancel'); ?></a>
                  <button type="submit" name="submit" class="btn btn-primary btn-sm"><?php echo 'Save';//lang('core button save'); ?></button>
                </div>
              </div>
              </div>
          ...
          <div class="panel-group" id="accordion">
              <div class="card card-default">
                <div class="card-header">
                  <div class="header-block">
                      ...
                      <?php echo 'Add Balance'; //lang('admin trans add_ball'); ?>
                    </a>
                  </div>
                  ...
                  <div class="card-block">
                   ...
                   <?php echo form_open(site_url("admin/users/add_user_transaction/" . $user['id']), array("" => "")) ?>
                      ...
                      <div class="form-group col-sm-3">
                        <label class="control-label"><?php echo 'Type'; //lang('admin trans type'); ?></label>
                        <span class="required">*</span>
                          <div>
                              <label style="font-weight:500">
                                  <input type="radio" class="radio" name="type" value="1" id="1"  />
                                   <span><?php echo 'Deposit';//lang('admin trans deposit'); ?></span>
                              </label>
                          </div>
                          <div>
                              <label  style="font-weight:500">
                                  <input type="radio" class="radio" name="type" value="3" id="3"  />
                                  <span><?php echo 'Transfer';//lang('admin trans transfer'); ?></span>
                              </label>
                          </div>
                          <div>
                              <label  style="font-weight:500">
                                  <input type="radio" class="radio" name="type" value="4" id="4"  />
                                  <span><?php echo 'Exchange';//lang('admin trans exchange'); ?></span>
                              </label>
                          </div>
                          <div>
                              <label  style="font-weight:500">
                                  <input type="radio" class="radio" name="type" value="5" id="5"  />
                                  <span><?php echo 'External';//lang('admin trans external'); ?></span>
                              </label>
                          </div>
                      </div>
                      ...
                      <div class="form-group col-sm-5">
                          <label><?php echo 'Amount';//lang('admin trans amount'); ?></label>
                          <span class="required">*</span>
                          <input type="text" class="form-control underlined" id="amount" name="amount" placeholder="" value="0.00"> 
                      </div>
                      <div class="form-group col-sm-4">
                          <label><?php echo 'Currency';//lang('admin button currency'); ?></label>
              ...
              <div class="row">
                  ...
                  <div class="form-group col-sm-6">
                      <label><?php echo 'Comment';//lang('admin trans comment'); ?></label>
                      <span class="required">*</span>
                   <textarea class="form-control underlined" id="user_comment" name="user_comment"> </textarea>
                  </div>
                  <div class="form-group col-sm-6">
                      <label><?php echo 'Admin note';//lang('admin trans admin_comment'); ?></label>
                      <span class="required">*</span>
                  ...
                  <div class="card-footer" style="text-align:right"> 
                      <a class="btn btn-secondary btn-sm" href="<?php echo $cancel_url; ?>"><?php echo 'Cancel';//lang('core button cancel'); ?></a>
                      <button type="submit"  class="btn btn-primary btn-sm"><?php echo 'Sava';//lang('core button save'); ?></button>
                  </div>
                </div>
              </div>
            <?php echo form_close(); ?> 
              ...
              <div class="card-header">
                <div class="header-block">
                  <a data-toggle="collapse" class="title" data-parent="#accordion" href="#szukaj">
                    <?php echo 'Charge by balance';//lang('admin trans win_ball'); ?>
                  </a>
                </div>
              </div>
                          ...
                          <div>
                              <label style="font-weight:500">
                                  <input type="radio" class="radio" name="type" value="2" id="2"  />
                                   <span><?php echo 'Withdrawal';//lang('admin trans withdrawal'); ?></span>
                              </label>
                          </div>
                          <div>
                              <label style="font-weight:500">
          ...
          <div role="tabpanel" class="tab-pane" id="all">
            <div class="row">
              <div class="col-md-12">
                <h5><?php echo 'Last 10 outgoing transactions';//lang('admin log last_trans'); ?></h5>
                <br>
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
                      <th><?php echo 'Id';//lang('admin trans id'); ?></th>
                      <th><?php echo 'Type';//lang('admin trans type'); ?></th>
                      <th><?php echo 'Status';//lang('admin trans status'); ?></th>
                      <th><?php echo 'Sender';//lang('admin trans sender'); ?></th>
                      <th><?php echo 'Receiver';//lang('admin trans receiver'); ?></th>
                      <th><?php echo 'Time';//lang('admin trans time'); ?></th>
                      <th><?php echo 'Currency';//lang('admin button currency'); ?></th>
                      <th><?php echo 'Amount';//lang('admin trans amount'); ?></th>
                      <th><?php echo 'Fee';//lang('admin trans fee'); ?></th>
                      <th><?php echo 'Sum';//lang('admin trans sum'); ?></th>
                    </thead>
                    <tbody>
                ...
                <div class="text-center">
                  <a href="/admin/transactions?sort=id&dir=desc&limit=10&offset=0&sender=<?php echo set_value('username', (isset($user['username']) ? $user['username'] : '')); ?>" target="_blank" class="btn btn-primary btn-sm"><i class="icon-eye icons"></i> <?php echo 'All outgoing transactions';//lang('admin log see_trans'); ?></a>
                </div>
              </div>
              <div class="col-md-12">
                <br>
                <h5><?php echo 'Last 10 incoming transactions';//lang('admin log last_trans_in'); ?></h5>
                <br>
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
                ...
                <div class="text-center">
                  <a href="/admin/transactions?sort=id&dir=desc&limit=10&offset=0&receiver=<?php echo set_value('username', (isset($user['username']) ? $user['username'] : '')); ?>" target="_blank" class="btn btn-primary btn-sm"><i class="icon-eye icons"></i> <?php echo 'All incoming transactions';//lang('admin log see_trans_in'); ?></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div role="tabpanel" class="tab-pane" id="logs">
            <div class="row">
              <div class="col-md-12">
                <h5><?php echo 'Last 20 operations';//lang('admin log last_operations'); ?></h5><br>
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
                      <th><?php echo 'Date';//lang('admin log date'); ?></th>
                      <th><?php echo 'Event';//lang('admin log event'); ?></th>
                      <th><?php echo 'IP adress';//lang('admin log ip'); ?></th>
                      <th><?php echo 'device';//lang('admin log device'); ?></th>
                    </thead>
                    <tbody>
                ...
                <div class="text-center">
                  <a href="/admin/logs?sort=date&dir=asc&limit=10&offset=0&user=<?php echo set_value('username', (isset($user['username']) ? $user['username'] : '')); ?>" target="_blank" class="btn btn-primary btn-sm"><i class="icon-eye icons"></i> <?php echo 'See all operations'//lang('admin log see_operations'); ?></a>
                </div>
               </div>
             </div>
          </div>
          ...
          <div role="tabpanel" class="tab-pane" id="doc">
            <div class="row">
              <div class="col-md-12">
                <h5><?php echo 'List documents';//lang('admin verification list'); ?></h5><br>
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
                      <th><?php echo 'ID'; //lang('admin trans id'); ?></th>
                      <th><?php echo 'Document'; //lang('admin verification img'); ?></th>
                      <th><?php echo 'Username'; //lang('admin tickets user'); ?></th>
                      <th><?php echo 'Type'; //lang('admin trans type'); ?></th>
                      <th><?php echo 'Create date'; //lang('admin tickets date'); ?></th>
                      <th><?php echo 'Status'; //lang('admin trans status'); ?></th>
                      <th></th>
                    </thead>
                    <tbody>
