...
class Users extends Base_Controller {
    ...
    function index()
    {
        ...
        // load views
        $data['content'] = $this->load->view('list', $content_data, TRUE);
    ...
    function add()
    {
        ...
        // load views
        $data['content'] = $this->load->view('add', $content_data, TRUE);
        // $this->load->view($this->template, $data);        
         $this->load->view('template', $data);
    }
    ...
    function edit($id = NULL)
    {
        ...
        $users_business = $this->users_model->get_users_business($id);
