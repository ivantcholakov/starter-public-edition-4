            ...
            <?php echo form_open('', array('role'=>'form')); ?>
              ...
              <div class="row">  
                  ...
                  <div class="form-group col-sm-4">
                        <label>Country <?php echo $users_business['country']; ?></label>
                            <select name="country" id="country" class="form-control underlined">
                                 <option value="">Select</option>
                                        <?php
                                        $sql = "SELECT * FROM countries";
                                        $counrty = $this->db->query($sql);
                                        foreach($counrty->result_Array() as $counrty_list){ ?>
                                             <option value="<?php echo $counrty_list['country_id']; ?>" <?php if($counrty_list['country_id'] == $users_business['country']){ echo "selected"; } ?> ><?php echo $counrty_list['name']; ?></option>
                                        <?php } ?>
                                    </select>
                            </select>
                    </div>
