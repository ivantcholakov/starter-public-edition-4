...
class Merchants extends Base_Controller {
    ...
    function active()
    {
        ...
        // load views
		$data['content'] = $this->load->view('active', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
    ...
    function moderation()
    {
	   ...
	   // build filter string
        ...
        // load views
		$data['content'] = $this->load->view('moderation', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
    ...
    function disapproved()
    {
        ...
        // load views
		$data['content'] = $this->load->view('disapproved', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
