...
<!--<div style="background-image:url('<?php echo base_url(); ?>assets/img/backgrounds/1.jpg')">-->
<body style="background-image:url('<?php echo base_url(); ?>assets/images/Video_Image.jpg')">

	<div class="container">
		<div class="row">
		<br /><br /><br /><br /><br /><br />
		<center>
			<div class="col-sm-6" style="background: rgba(0, 0, 0, -6.3);border-radius: 20px;border: 1px solid #272625;background: rgb(239, 244, 240);float: initial;">
			...
			<p class="desc">We will sent a six-digit confirmation code to <strong><?php echo $this->session->userdata('reg_email'); ?></strong>Enter it below to confirm your email address.</p>
			<br><br>
	
		   <label><span class="normal">Your confirmation code</span></label>
	
	<form method="post" class="ui sw-main sw-theme-default my-5" id="codeFrm" name="codeFrm" enctype="multipart/form-data" accept-charset="utf-8" action="<?php echo site_url("chk-code") ?>">                    
			 <div class="confirmation_code split_input large_bottom_margin" data-multi-input-code="true">
				...
				<span>Didn't receive it?<a href="<?php echo site_url("send_again_code_verification") ?>" style="color: #1708fd;"> SEND AGAIN  </a> </span><br><br> 
...
body {
    margin:0;
    padding:0;
    /*background:url('<?php echo base_url(); ?>assets/images/Video_Image.jpg') no-repeat center center fixed;*/
...
setInterval(function () {
    ...
    if(code_1!='' && code_2!='' && code_3!='' && code_4!='' && code_5!='' && code_6!='' ){
        ...
        $("#codeFrm").submit();
        // $.ajax({
        //     url: '<?php echo site_url("chk-code") ?>',
        //     type: 'POST',
        //     datatype: 'json',
        //     data: { code:code},
        //     success: function (data) {
