...
class Transactions extends Base_Controller {
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('pending', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
        ...
        // load views
	    $data['content'] = $this->load->view('confirmed', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
	   ...
	   // set content data
        ...
        // load views
		$data['content'] = $this->load->view('disputed', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('blocked', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
    ...
    function refunded()
    {
		...
		// save the current url to session for returning
        $this->session->set_userdata(REFERRER, THIS_URL_6 . "?sort={$sort}&dir={$dir}&limit={$limit}&offset={$offset}"); //{$filters}
  ...
  //       $data = $this->includes;
        ...
        // load views
		$data['content'] = $this->load->view('refunded', $content_data, TRUE);
        // $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }
	...
	function edit($id = NULL)
    {
        ...
        // load views
        $data['content'] = $this->load->view('form', $content_data, TRUE);
        $this->load->view($this->template, $data);
        $this->load->view('template', $data);
    }	
