...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title> <?php  //echo $page_title; ?> Dashboard - <?php //echo $this->settings->site_name; ?> Admin </title>
                        ...
                        <nav class="menu">
                            ...
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="<?php echo (uri_string() == 'admin' OR uri_string() == 'admin/dashboard') ? 'active' : ''; ?>">
                                    ...
                                    <a href="<?php echo site_url('dashboard'); ?>"> <i class="icon-home icons"></i> <?php echo lang('admin button dashboard'); ?></a>
                                ...
                                <li class="<?php echo (strstr(uri_string(), 'admin/users')) ? 'active open' : ''; ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li class="<?php echo (uri_string() == 'admin/users') ? 'active' : ''; ?>"> <a href="<?php echo site_url('admin/users'); ?>">

                                    <?php echo lang('admin button users_list'); ?>

                                </a> </li>

                                        <li class="<?php echo (uri_string() == 'admin/users/add') ? 'active' : ''; ?>"> <a href="<?php echo site_url('admin/users/add'); ?>">
                                ...
                                <li class="<?php echo (strstr(uri_string(), 'admin/transactions')) ? 'active open' : ''; ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li class="<?php echo (uri_string() == 'admin/transactions') ? 'active' : ''; ?>"> <a href="<?php echo site_url('admin/transactions'); ?>">
                                ...
                                <li class="<?php echo (strstr(uri_string(), 'admin/disputes')) ? 'active open' : ''; ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li class="<?php echo (uri_string() == 'admin/disputes') ? 'active' : ''; ?>"> <a href="<?php echo site_url('admin/disputes'); ?>">
                                ...
                                <li class="<?php echo (strstr(uri_string(), 'admin/template_msg')) ? 'active open' : ''; ?>">

                                    <a href=""> <i class="icon-layers icons"></i> <?php echo lang('admin button template'); ?> <i class="fa arrow"></i> </a>

                                    <ul>

                                        <li class="<?php echo (uri_string() == 'admin/template_msg') ? 'active' : ''; ?>"> <a href="<?php echo base_url('/admin/template_msg'); ?>">

                                    <?php echo lang('admin template email'); ?>

                                </a> </li>

                                        <li class="<?php echo (uri_string() == 'admin/template_msg/sms') ? 'active' : ''; ?>"> <a href="<?php echo base_url('/admin/template_msg/sms'); ?>">
                                ...
                                <li class="<?php echo (uri_string() == 'admin/settings_info') ? 'active' : ''; ?>">

                                    <a href="<?php echo base_url('/admin/settings_info'); ?>"> <i class="icon-equalizer icons"></i> <?php echo lang('admin button settings'); ?> </a>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-block author">
                        ...
                        <ul>
                            ...
                            <li>Just Wallet  1.1.5 <?php //echo $this->settings->site_version; ?></li>
