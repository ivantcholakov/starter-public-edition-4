...
?>
                        ...
                        <?php echo form_open('', 'id="test_form" method="post" role="form"'); ?>
                            ...
                            <div class="form-group">
                                <label for="input">The input, JSON source:</label>
                                <textarea id="input" name="input" class="form-control" rows="10" placeholder="Copy/paste your JSON source here."><?php echo $clear_form || $is_example ? form_prep($input, true) : set_value('input', $input, true); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="output">The result, minified JSON:</label>
