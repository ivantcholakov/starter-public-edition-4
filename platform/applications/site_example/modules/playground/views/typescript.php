        ...
        <section>
            ...
            <div class="container">
                ...
                <div class="page-header">
                    <h1>TypeScript Compiler Test</h1>
                </div>
...
?>
                        ...
                        <?php echo form_open('', 'id="test_form" method="post" role="form"'); ?>
                            ...
                            <div class="form-group">
                                <label for="input">The input, TypeScript source:</label>
                                <textarea id="input" name="input" class="form-control" rows="10" placeholder="Copy/paste your TypeScript source here."><?php echo $clear_form || $is_example ? form_prep($input, true) : set_value('input', $input, true); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="output">The result, JavaScript:</label>
                                <textarea id="output" class="form-control" rows="10"><?php echo form_prep($output, true); ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="output_min">The result, minified JavaScript:</label>
