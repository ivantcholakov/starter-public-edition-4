...
$config = array(
    /* document */    array('Source', '-', 'Save', 'NewPage', 'DocProps', 'Preview', 'Print', '-', 'Templates'),
    /* clipboard */   array('Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo'),
    /* editing */     array('Find', 'Replace', '-', 'SelectAll'/*, '-', 'SpellChecker', 'Scayt'*/),
    /* forms */       array('Form', 'Checkbox', 'Radio', 'TextField', 'Textarea', 'Select', 'Button', 'ImageButton', 'HiddenField'),
    '/',
