...
if (!function_exists('js_modernizr')) {
    ...
    function js_modernizr() {
        ...
        return '    <script type="text/javascript" src="'.html_attr_escape(base_url('assets/composer-asset/components/modernizr/modernizr.js')).'"></script>';
    }
...
if (!function_exists('js_jquery')) {
    ...
    function js_jquery() {
        ...
        return '    <script type="text/javascript" src="'.html_attr_escape(base_url('assets/composer-asset/components/jquery/jquery.min.js')).'"></script>';
    }
