...
$lang['upload_file_exceeds_form_limit'] = 'Le fichier envoyé dépasse la taille limite définie dans votre formulaire d\'envoi.';
$lang['upload_file_partial']            = 'Le fichier n\'a été que partiellement envoyé.';
$lang['upload_no_temp_directory']       = 'Il manque le répertoire temporaire.';
$lang['upload_unable_to_write_file']    = 'Le fichier n\'a pas pu être enregistré sur le disque.';
$lang['upload_stopped_by_extension']    = 'L\'envoi du fichier a été stoppé par l\'extension.';
$lang['upload_no_file_selected']        = 'Vous n\'avez pas choisi de fichier à envoyer.';
...
$lang['upload_no_file_types']           = 'Vous n\'avez pas spécifié de type de fichiers autorisés.';
