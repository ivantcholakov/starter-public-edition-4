...
<div class="ui message alert alert-info alert-dismissible fade show">
...
<div class="ui compact message centered-block alert alert-dark-info alert-dismissible fade show">
    <button type="button" class="close" data-dismiss="alert">×</button>
                            <?php echo $normal_message; ?>
                        </div>
                    </div>
...
<div class="ui message alert alert-dark-success alert-dismissible fade show">
       <button type="button" class="close" data-dismiss="alert">×</button>
...
?>
                    ...
                    <div class="centered-block-container">
<div class="ui compact message centered-block alert alert-dark-success alert-dismissible fade show">
   <button type="button" class="close" data-dismiss="alert">×</button>
                            <?php echo $confirmation_message; ?>
                        </div>
                    </div>
...
<div class="ui message alert alert-dark-warning alert-dismissible fade show">
<button type="button" class="close" data-dismiss="alert">×</button>
...
?>
         ...
         <div class="centered-block-container">
<div class="ui compact message centered-block alert alert-dark-warning alert-dismissible fade show">
        <button type="button" class="close" data-dismiss="alert">×</button>
                            <?php echo $warning_message; ?>
                        </div>
                    </div>
...
?>
 ...
 <div class="ui message alert alert-dark-danger alert-dismissible fade show">
<button type="button" class="close" data-dismiss="alert">×</button>
...
?>
                    ...
                    <div class="centered-block-container">
<div class="ui compact message centered-block alert alert-dark-danger alert-dismissible fade show">
 <button type="button" class="close" data-dismiss="alert">×</button>
                            <?php echo $error_message; ?>
                        </div>
                    </div>
...
?>
            ...
            var visual_class = 'ui alert alert-dark-info alert-dismissible fade show';
<?php
...
?>
            ...
            var visual_class = 'ui alert alert-dark-info alert-dismissible fade show centered-block';
<?php
...
?>
                    ...
                    visual_class = 'ui alert alert-dark-success alert-dismissible fade show';
<?php
...
?>
                    ...
                    visual_class = 'ui alert alert-dark-success alert-dismissible fade show centered-block';
<?php
...
?>
                    ...
                    visual_class = 'ui alert alert-dark-warning alert-dismissible fade show';
<?php
...
?>
                    ...
                    visual_class = 'alert alert-dark-warning alert-dismissible fade show centered-block';
<?php
...
?>
                    ...
                    visual_class = 'ui alert alert-dark-danger alert-dismissible fade show';
<?php
...
?>
                    ...
                    visual_class = 'ui alert alert-dark-danger alert-dismissible fade show centered-block';
<?php
...
?>
            ...
            $('#<?php echo $feedback_message_id; ?>').html('<div class="' +  visual_class + '"> <button type="button" class="close" data-dismiss="alert">×</button> ' +  message + ' </div>');
<?php
...
?>
            ...
            $('#<?php echo $feedback_message_id; ?>').html('<div class="centered-block-container"><div class="' +  visual_class + '"> <button type="button" class="close" data-dismiss="alert">×</button> ' +  message + ' </div></div>');
<?php
