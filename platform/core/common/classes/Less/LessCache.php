...
if (!class_exists('Less_extendFinderVisitor', false)) {
    include dirname(__FILE__).'/Visitor/extend-visitor.php';
}

if (!class_exists('Less_importVisitor', false)) {
    include dirname(__FILE__).'/Visitor/import-visitor.php';
}

if (!class_exists('Less_joinSelectorVisitor', false)) {
    include dirname(__FILE__).'/Visitor/join-selector-visitor.php';
}

if (!class_exists('Less_processExtendsVisitor', false)) {
    include dirname(__FILE__).'/Visitor/process-extends-visitor.php';
}
