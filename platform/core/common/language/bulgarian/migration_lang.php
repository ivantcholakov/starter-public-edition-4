...
$lang['migration_not_found']            = "Миграцията не може да бъде намерена.";
$lang['migration_sequence_gap']         = 'Има липса в последователносста за миграция близо до версия: %d.';
$lang['migration_multiple_version']     = "Има няколко миграции с една и съща версия: %d.";
