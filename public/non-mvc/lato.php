...
<head>
    ...
    <link href="<?php echo css_url('lib/lato/latofonts.min.css'); ?>" rel="stylesheet" type="text/css">
...
<body lang="en">
    <div id="menu">
        <ul id="nav">
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebHairline';document.getElementById('main').style.fontStyle='normal';">Lato Hairline</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebHairline';document.getElementById('main').style.fontStyle='italic'">Lato Hairline Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebThin';document.getElementById('main').style.fontStyle='normal';">Lato Thin</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebThin';document.getElementById('main').style.fontStyle='italic'">Lato Thin Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebLight';document.getElementById('main').style.fontStyle='normal';">Lato Light</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebLight';document.getElementById('main').style.fontStyle='italic'">Lato Light Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWeb';document.getElementById('main').style.fontStyle='normal';">Lato Regular</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWeb';document.getElementById('main').style.fontStyle='italic';">Lato Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebMedium';document.getElementById('main').style.fontStyle='normal';">Lato Medium</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebMedium';document.getElementById('main').style.fontStyle='italic';">Lato Medium Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebSemibold';document.getElementById('main').style.fontStyle='normal';">Lato Semibold</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebSemibold';document.getElementById('main').style.fontStyle='italic';">Lato Semibold Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebBold';document.getElementById('main').style.fontStyle='normal';">Lato Bold</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebBold';document.getElementById('main').style.fontStyle='italic';">Lato Bold Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebHeavy';document.getElementById('main').style.fontStyle='normal';">Lato Heavy</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebHeavy';document.getElementById('main').style.fontStyle='italic';">Lato Heavy Italic</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebBlack';document.getElementById('main').style.fontStyle='normal';">Lato Black</a></li>
            <li><a href="javascript:void(0);" onclick="document.getElementById('main').style.fontFamily='LatoWebBlack';document.getElementById('main').style.fontStyle='italic';">Lato Black Italic</a></li>
        </ul>
    </div>
    <div id="main" style="font-family: 'LatoWeb'; font-style: normal;">
        <div class="waterfall">
            <table class="sample_table">
                <tbody>
                    <tr>
                        <td>10</td>
                        <td contenteditable="true" class="editable size10">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>11</td>
                        <td contenteditable="true" class="editable size11">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>12</td>
                        <td contenteditable="true" class="editable size12">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>13</td>
                        <td contenteditable="true" class="editable size13">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>14</td>
                        <td contenteditable="true" class="editable size14">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>16</td>
                        <td contenteditable="true" class="editable size16">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>18</td>
                        <td contenteditable="true" class="editable size18">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>20</td>
                        <td contenteditable="true" class="editable size20">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>24</td>
                        <td contenteditable="true" class="editable size24">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>30</td>
                        <td contenteditable="true" class="editable size30">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>36</td>
                        <td contenteditable="true" class="editable size36">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>48</td>
                        <td contenteditable="true" class="editable size48">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>60</td>
                        <td contenteditable="true" class="editable size60">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>72</td>
                        <td contenteditable="true" class="editable size72">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                    <tr>
                        <td>90</td>
                        <td contenteditable="true" class="editable size90">aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź0123456789aąbcćdeęfghijklłmnńoópqrśtuvwxyzżźaąbcćdeęfghijklłmnńoópqrśtuvwxyzżź</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div contenteditable="true" class="editable large">
