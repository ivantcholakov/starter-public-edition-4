...
// Removed by Ivan Tcholakov, 19-OCT-2013.
//// CMS INTEGRATION
//if (isset($_GET['cms'])) {
//    switch ($_GET['cms']) {
...
// Modified by Ivan Tcholakov, 20-OCT-2013.
...
//}
if (!function_exists('_kcfinder_autoloader')) {

    function _kcfinder_autoloader($class) {
    ...
    spl_autoload_register('_kcfinder_autoloader');
}
//
